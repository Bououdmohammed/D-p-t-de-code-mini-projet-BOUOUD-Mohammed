...
osMessageQId myQueueBompeHandle;
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
// Variables pour communiquer entre les 2 cartes
uint8_t rxbuffer[10];
uint8_t txbuffer[10];
uint16_t x_homme;
uint16_t pos_diablex;
uint16_t pos_Bompey;
uint16_t y_missile;
uint16_t Game_Over = 0; // if 1 you win , if 2 you loss
uint8_t Bompe=0;
/* USER CODE END 0 */
...
/* USER CODE BEGIN Header_Task_Transmit_data */
/**
...
void Task_Transmit_data(void const * argument)
{
  ...
  /* USER CODE END Task_Transmit_data */
}

/* USER CODE BEGIN Header_Task_missile */
/**
