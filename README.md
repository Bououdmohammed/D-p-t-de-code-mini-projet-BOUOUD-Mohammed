...
Pour que les deux modules RN42 communiquent entre eux, certaines configurations sont nécessaires : Conformément à la norme Bluetooth 2.0, un module BT RN42 sera configuré en mode *SLAVE*, l'autre en mode *MASTER*. Le *MASTER* cherche à son alimentation la disponibilité du *SLAVE* dont l'adresse est connue par lui, puis il se connecte automatiquement à sont *SLAVE* et la liaison Bluetooth s'établie. Pour se faire, un réglage minimal est nécessaire pour chaque module RN42. 
